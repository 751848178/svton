...
assert.doesNotMatch(appCompose, /additional_contexts:/);
const localWebStage = dockerfile.slice(
  dockerfile.indexOf("FROM base AS local-web"),
  dockerfile.indexOf("FROM base AS web"),
);
assert.match(
  localWebStage,
