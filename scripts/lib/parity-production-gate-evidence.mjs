...
export function productionGateEvidenceChecks(proof = {}) {
  ...
  return [
    ...
    check("gateDeploymentReleaseRunId", expected.deploymentReleaseRunId, expected.releaseRunId),
    check("gateDeploymentEnvironmentId", expected.deploymentEnvironmentId, expected.environmentId),
    check("gateDeploymentManifestId", expected.deploymentManifestId, expected.manifestId),
