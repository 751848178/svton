...
export const NEGATIVE_CHECKS_C = {
  ...
  "ac-033-db-state": (r) => [
    ...
    eq("routeSwitchEvidenceStatus", r.routeSwitchEvidenceStatus, "switched"),
    eq("routeSwitchRuns", r.routeSwitchRunsForFailedDeploy, 1),
    yes("routeActuallySwitched", r.routeActuallySwitched),
  ...
  "ac-033-restore-route": (r) => [
    eq("putStatus", r.putStatus, 204),
    yes("restoredOperation", r.restoredOperation),
    yes("restoredRouteHash", r.restoredRouteHash),
    eq("liveProxyStatusCode", r.liveProxyStatusCode, 200),
    eq("liveProxyMarker", r.liveProxyMarker, "Parity Target Workload"),
  ],
