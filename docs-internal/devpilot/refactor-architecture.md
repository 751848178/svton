...
| 页面迁移 | 状态 |
|---|---|
| backups / audit-events / git / presets / domain / resources / keys / teams / teams[id] / cdn / cdn-configs / cdn-configs[id] / proxy-configs / proxy-configs[id] / servers / servers[id] / projects / projects-new / projects-import / resource-instances / admin/resource-pools / admin/resource-types / operation-approvals / execution-policies / access-policies | ✅ 已迁移（25 页，每文件 <200 行） |
| projects/[id]（types/utils 已抽取，主组件 3817 行待拆） | ⏳ 进行中 |
| 其余超大页（resource-control 3520 / monitoring 2598 / logs 2001 / sites 1910 / resource-requests 1431 / execution-governance 1302 / applications 847） | ⏳ 待迁移（模式已验证可复用） |
