...
| F555 | P1 confirmed/queued | evidence/identity; F542, AC-E2E-020..021 | standard and recovery preview input hashes are validated only as hex and never bound to the subsequent confirm requests | Production preview/confirm result identity + focused fixtures only | coherent hash substitution accepted / serialize actual request hash and require confirm to equal the preceding trusted preview hash |
