...
| F543 | P1 fixed/review pending | evidence/security; F539, AC-E2E-023 | explicit auth/proxy-auth/cookie/set-cookie values are collected as non-overlapping original-text spans and replaced once, preserving true boundaries while covering custom/no scheme, cookie pairs and attributes | CDP header/key-value redaction grammar + focused tests only | `5755b4ce`; focused custom/proxy/cookie/quoted/idempotence and F530/F539 regressions passed, independent review pending |
