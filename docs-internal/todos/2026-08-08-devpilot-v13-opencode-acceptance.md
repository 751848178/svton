...
| Version history | repeat Staging without BuildRun growth, upgrades and Staging/Production recoveries | verified with limitation | F555 preview/confirm identity continuity fixed; current real-MySQL tests pass; clean current-image E2E and F537 launcher still pending; F473/F556-F560 remain |
