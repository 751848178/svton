...
| F530 | P1 fixed | evidence/security; F522, AC-E2E-023 | Runtime exception text/URLs now redact full authorization tails, credentials, sensitive query and fragments | CDP redaction helper/self-test only / no browser product fix | `7c4d12a1`, targeted redaction fixtures; not claimed as generic DLP |
| F531 | P1 confirmed/queued | evidence/browser; F523, AC-E2E-023 | empty httpResponses and malformed response elements can pass despite a valid top-level schema | CDP element schema/summary tests only / no runtime network change | pure Node repro / require nonempty typed URL/host/type/status rows and exact host derivation |
| F532 | P1 confirmed/queued | evidence/browser; F507, AC-E2E-023 | six UI evidence groups may be omitted while one remaining true marker makes the aggregate gate pass | history summary check/self-test only / no visual redesign | pure Node repro / require every named group and every required boolean marker |
| F533 | P1 confirmed/queued | evidence/browser; F529, AC-E2E-023 | artifact readback accepts symlinks and marker text is reread after verified bytes, enabling TOCTOU drift | artifact readback/marker parser only / no browser runtime mutation | pure file repro / reject symlink/non-regular files and derive metadata+markers from one held byte snapshot |
