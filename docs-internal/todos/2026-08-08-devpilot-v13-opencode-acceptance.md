...
| F530 | P1 core fixed/follow-ups F544-F546 | evidence/security; F522, AC-E2E-023 | Runtime exception sanitizer covers common credential fields and full URL fragments, and F543 now closes complete auth/cookie value parsing; non-exception capture branches, separator and over-redaction gaps remain | CDP capture/redaction helpers and focused tests only / no browser product fix | `7c4d12a1`, `8885b24f`, `0568fd33`, `5755b4ce`; not claimed as generic DLP |
...
| F539 | P1 core fixed/follow-ups F544-F546 | evidence/security; F530, AC-E2E-023 | centralized vocabulary covers common credential fields and F543 parses complete explicit auth/cookie spans; all-branch capture sanitation and vocabulary precision remain | CDP redaction vocabulary/self-test only / no generic DLP expansion | `8885b24f`, `0568fd33`, `5755b4ce`; F544-F546 remain |
...
| F544 | P1 confirmed/handoff required | evidence/security; F530, AC-E2E-023 | sanitizer is applied to `Runtime.exceptionThrown` only; console, Log, HTTP response and failed-request evidence can persist explicit credentials unchanged | CDP capture normalization for every persisted text/URL branch only | experimental `d18257e4` was fully reverted by `290f3b95` at user-requested cost closure; no F544 implementation is retained |
...
| F547 | P1 descriptor fixed/F544 dependency | evidence/security; F507, AC-E2E-023 | raw actions remain in-memory and CDP evidence v2 persists exact secret-free descriptors; post-review confirms this scope but full evidence still leaks navigation URL credentials through unsanitized Network capture | CDP driver action serialization/redaction + focused evidence tests only | `e6c93fb9`; 18 schema adversaries and executor/error checks passed; full-chain acceptance waits for existing F544 |
