...
| F530 | P1 confirmed/queued | evidence/security; F522, AC-E2E-023 | Runtime exception redaction leaks Bearer token tails and URL-fragment secrets | CDP redaction helper/self-test only / no browser product fix | pure Node repro / redact full auth values, credentials, query and fragment secrets |
