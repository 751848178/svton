...
| F509 | P2 fixed | evidence script; F473, F455 context | consumer now requires exact AC-E2E-007..015 and binds every AC source step/check | history context helper only / no positive runner behavior | `03ef541e`, 13 adversarial fixtures |
...
| F522 | P1 confirmed/queued | evidence/browser; F507, AC-E2E-023 | repo CDP capture ignores `Runtime.exceptionThrown`, so uncaught page exceptions can appear clean | CDP capture/check/self-test only / no browser product fix | F507 post-review / record exception details and fail closed |
