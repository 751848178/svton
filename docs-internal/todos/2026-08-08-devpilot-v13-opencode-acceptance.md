...
| F529 | P1 confirmed/queued | evidence/browser; F524, AC-E2E-023 | history runner trusts artifact metadata printed on driver stdout without independently reading current files | browser artifact readback/helper only / no cdp-evidence hash overlap with F511 | root review / read each artifact, recompute SHA/bytes/kind/signature, require exact reported match |
