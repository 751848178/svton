...
describe('EnvironmentSettingsArea Demo-aligned environment configuration', () => {
  ...
  beforeEach(() => {
    ...
    mocks.governance = {
      ...
      policies: [
        { id: 'p1', name: 'Production approval', effect: 'allow', enabled: true, project: null, environment: null },
      ],
      loading: false,
      saving: false,
      error: '',
  ...
  it('shows the five Demo-aligned subtabs and no long config drawer', () => {
    ...
    for (const key of ['envTabTargets', 'envTabResources', 'envTabVariables', 'envTabRoutes', 'envTabProtection']) {
    ...
    project: {
      ...
      environments: [
        ...
        },
        {
          ...
          currentConfigRevisionId: null,
          serverBindings: [],
          _count: { serverBindings: 0, sites: 1, deploymentRuns: 9, managedResources: 2, resourceRequests: 0, resourceInstances: 3, cdnConfigs: 0, secretKeys: 2 },
        },
      ],
      sites: [],
      secretKeys: [],
