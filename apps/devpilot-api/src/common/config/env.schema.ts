...
export const envSchema = z
  .object({
    ...
    ALERT_NOTIFICATION_RETRY_SCHEDULER_ENABLED: booleanString
      .default("true")
      .optional(),
    ...
    LOG_CENTER_SERVER_FOLLOW_DEFAULT_INTERVAL_MINUTES:
      positiveInt(1).default(5),
    ...
    DEPLOYMENT_AUTO_ROLLBACK_SCHEDULER_INTERVAL_SECONDS:
      positiveInt(1).default(60),
    DEPLOYMENT_AUTO_ROLLBACK_SCHEDULER_BATCH_SIZE: positiveInt(1).default(50),
    DEPLOYMENT_POST_ROLLBACK_SMOKE_SCHEDULER_ENABLED:
      booleanString.default("true"),
    DEPLOYMENT_POST_ROLLBACK_SMOKE_SCHEDULER_INTERVAL_SECONDS:
      positiveInt(1).default(60),
    DEPLOYMENT_POST_ROLLBACK_SMOKE_SCHEDULER_BATCH_SIZE:
      positiveInt(1).default(50),

    // ---------- 生成器清理调度器 ----------
    PROJECT_ARTIFACT_CLEANUP_SCHEDULER_ENABLED: booleanString.default("true"),
    PROJECT_ARTIFACT_CLEANUP_SCHEDULER_INTERVAL_SECONDS:
      positiveInt(1).default(3600),
    PROJECT_ARTIFACT_CLEANUP_SCHEDULER_DRY_RUN: booleanString.default("false"),
    DEVPILOT_GENERATED_PROJECT_ARTIFACT_RETENTION_DAYS:
      positiveInt(1).default(7),
    ...
    RESOURCE_CONTROL_SCHEDULE_DOCKER_METRICS_ENABLED:
      booleanString.default("true"),
    RESOURCE_CONTROL_SCHEDULE_DOCKER_METRICS_BATCH_SIZE:
      positiveInt(1).default(20),
    RESOURCE_CONTROL_SCHEDULE_DOCKER_METRICS_MIN_INTERVAL_SECONDS:
      positiveInt(1).default(60),
    RESOURCE_CONTROL_SCHEDULE_DOCKER_METRICS_MAX_ATTEMPTS:
      positiveInt(1).default(3),
    RESOURCE_CONTROL_SCHEDULE_DOCKER_SYNC_ENABLED:
      booleanString.default("true"),
    RESOURCE_CONTROL_SCHEDULE_SERVER_BATCH_SIZE: positiveInt(1).default(20),
    RESOURCE_CONTROL_CLOUD_INVENTORY_LIVE_ENABLED:
    ...
    RESOURCE_CONTROL_CLOUD_INVENTORY_RETRY_BASE_DELAY_MS:
      positiveInt(1).default(200),
    ...
    RESOURCE_REQUEST_PROVISIONING_RETRY_SCHEDULER_INTERVAL_SECONDS:
      positiveInt(1).default(60),
    RESOURCE_REQUEST_PROVISIONING_RETRY_SCHEDULER_BATCH_SIZE:
      positiveInt(1).default(50),
    RESOURCE_REQUEST_PROVISIONING_RUN_STALE_AFTER_SECONDS:
      positiveInt(1).default(600),
    RESOURCE_REQUEST_PROVISIONING_RUN_STALE_RECOVERY_ENABLED:
      booleanString.default("true"),
    RESOURCE_REQUEST_PROVISIONING_RUN_STALE_RECOVERY_BATCH_SIZE:
      positiveInt(1).default(50),
    RESOURCE_REQUEST_PROVISIONING_QUEUE_WORKER_ENABLED:
      booleanString.default("true"),
    RESOURCE_REQUEST_PROVISIONING_QUEUE_WORKER_BATCH_SIZE:
      positiveInt(1).default(20),
    RESOURCE_REQUEST_PROVISIONING_PROVIDER_STATE_POLLING_ENABLED:
      booleanString.default("true"),
    RESOURCE_REQUEST_PROVISIONING_PROVIDER_STATE_POLLING_BATCH_SIZE:
      positiveInt(1).default(20),
