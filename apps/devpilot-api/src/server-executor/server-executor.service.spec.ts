        ...
        taskPullReadiness: {
          ...
          gates: {
            ...
            pullContract: {
              ...
              ackSupported: false,
              ackCancellationHintSupported: false,
              ackProgressWritebackSupported: false,
              terminalWritebackSupported: false,
    ...
    const nextQueuedJob = {
      ...
      inputSnapshot: {
        metadata: {
          ...
          logCollectionRunId: "run-agent-1",
          sourceType: "docker",
          sourceKey: "api",
          params: {
