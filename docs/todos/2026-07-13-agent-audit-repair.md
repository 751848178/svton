...
| A005 | done | Verification | Run unit/type/build/e2e/browser or desktop verification and collect screenshots. | logs under `/tmp/codex-tool-runs/svton/agent-audit-repair/`; latest desktop quote fix logs: `agent-desktop-test-after-config-quote.log`, `agent-desktop-build-after-config-quote.log`; screenshots under `/tmp/codex-tool-runs/svton/agent-audit-repair/screenshots/` |
